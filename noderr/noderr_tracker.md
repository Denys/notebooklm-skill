...
---
**Progress: 83% (15/18 NodeIDs Implemented)**
---
...
| 🟢 `[VERIFIED]` | | `SVC_AskQuestion` | Ask Question | SVC_BrowserSession, AUTH_Manager, CONFIG_Settings | Browser Automation | [Spec](specs/SVC_AskQuestion.md) | Critical | Core query engine; interacts with NotebookLM |
...
| ⚪️ `[TODO]` | | `SVC_RetryLogic` | Retry Logic | SVC_BrowserSession, SVC_CleanupManager | Browser Automation | [Spec](specs/SVC_RetryLogic.md) | High | Required for MVP — no retry on crash/rate-limit |
