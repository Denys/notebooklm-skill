...
---
**Progress: 83% (15/18 NodeIDs Implemented) — WIP: wip-20260319-retry**
---
...
| 🟡 `[WIP]` | wip-20260319-retry | `SVC_AskQuestion` | Ask Question | SVC_BrowserSession, AUTH_Manager, CONFIG_Settings, SVC_RetryLogic | Browser Automation | [Spec](specs/SVC_AskQuestion.md) | Critical | Core query engine; interacts with NotebookLM |
...
| 🟡 `[WIP]` | wip-20260319-retry | `CONFIG_Settings` | Settings | — | Configuration | [Spec](specs/CONFIG_Settings.md) | Critical | CSS selectors, timeouts, browser args — update when NotebookLM UI changes |
...
| 🟡 `[WIP]` | wip-20260319-retry | `SVC_RetryLogic` | Retry Logic | CONFIG_Settings | Browser Automation | [Spec](specs/SVC_RetryLogic.md) | High | Required for MVP — no retry on crash/rate-limit |
